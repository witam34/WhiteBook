...
def renomear_questoes_simples():
    pasta = "57-71" # ATUALIZAR com o nome da pasta das questões que você vai arrumar 
    ...
    for i in range(65, 72+1):    # atualize seu for com o número da primeira imagem "parte_AlgumaCoisa.png" até o número da última imagem "parte_AlgumaCoisa.png" mais 1 da pasta
