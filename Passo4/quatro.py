...
for nome_arquivo in os.listdir(pasta_imagens):
    if nome_arquivo.lower().endswith(".png"):
        ...
        if nome_arquivo.endswith("_esquerda.png"):
            ...
            caixa_corte = (caixa_corte[0], caixa_corte[1], caixa_corte[2] - 21, caixa_corte[3]) # ATUALIZE AQUI O VALOR DE CORTE PARA A COLUNA DA ESQUERDA (esquerda, superior, direita, inferior)
